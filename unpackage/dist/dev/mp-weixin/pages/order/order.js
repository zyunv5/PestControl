...
/* harmony import */ var _order_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./order.vue?vue&type=style&index=0&lang=css& */ 41);
...
var _dayjs = _interopRequireDefault(__webpack_require__(/*! dayjs */ 49));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //
//
//
//
//
...
//
//
var _default = { data: function data() {return { isActive: 0, listData: [] };}, created: function created() {var that = this;var token = wx.getStorageSync("token");uni.request({ url: _config.default + 'getUserOrder', method: "GET", data: { token: token }, success: function success(res) {that.orderSort(res.data.data);} });}, methods: { changeTab: function changeTab(num) {this.isActive = num;},
