...
//
//
var _default = { data: function data() {var date = new Date();var years = [];var year = date.getFullYear();var months = [];var month = date.getMonth();var days = [];var day = date.getDate() - 1;for (var i = year; i <= date.getFullYear() + 10; i++) {years.push(i);}for (var _i = 1; _i <= 12; _i++) {months.push(_i);}for (var _i2 = 1; _i2 <= 31; _i2++) {days.push(_i2);}return { year: year, years: years, month: month, months: months, day: day, days: days, dayTime: [{ noon: "上午", time: "09:00", active: false }, { noon: "上午", time: "11:00", active: false }, { noon: "下午", time: "13:00", active: false }, { noon: "下午", time: "15:00", active: false }, { noon: "下午", time: "17:00", active: false }, { noon: "下午", time: "19:00", active: false }, { noon: "下午", time: "21:00", active: false }], area: "选择您所在社区", bgMap: ["东城区", "西城区", "朝阳区", "丰台区", "石景山区", "海淀区", "门头沟区", "房山区", "通州区", "顺义区", "昌平区", "大兴区", "平谷区", "怀柔区", "密云县", "延庆县"], areaColor: false, user: "", phone: "", address: "" };}, created: function created() {var token = wx.getStorageSync('token');if (!token) {uni.showToast({ title: "请先登录再进行预约", icon: "none", duration: 3000 });}}, methods: { // 更改年份
