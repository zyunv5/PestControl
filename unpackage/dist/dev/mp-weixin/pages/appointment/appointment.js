...
var _appointment = _interopRequireDefault(__webpack_require__(/*! ./pages/appointment/appointment.vue */ 43));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _appointment_vue_vue_type_template_id_4ce32746___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./appointment.vue?vue&type=template&id=4ce32746& */ 44);
/* harmony import */ var _appointment_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./appointment.vue?vue&type=script&lang=js& */ 46);
...
/* harmony import */ var _appointment_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./appointment.vue?vue&type=style&index=0&lang=css& */ 49);
...
var _config = _interopRequireDefault(__webpack_require__(/*! ../../common/config.js */ 101));
var _dayjs = _interopRequireDefault(__webpack_require__(/*! dayjs */ 48));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //
//
//
//
//
...
//
//
var _default = { data: function data() {var date = new Date();var years = [];var year = date.getFullYear();var months = [];var month = date.getMonth();var days = [];var day = date.getDate() - 1;for (var i = year; i <= date.getFullYear() + 10; i++) {years.push(i);}for (var _i = 1; _i <= 12; _i++) {months.push(_i);}for (var _i2 = 1; _i2 <= 31; _i2++) {days.push(_i2);}return { year: year, years: years, month: month, months: months, day: day, days: days, dayTime: [{ noon: '上午', time: '09:00', active: false }, { noon: '上午', time: '11:00', active: false }, { noon: '下午', time: '13:00', active: false }, { noon: '下午', time: '15:00', active: false }, { noon: '下午', time: '17:00', active: false }, { noon: '下午', time: '19:00', active: false }, { noon: '下午', time: '21:00', active: false }], area: '选择您所在社区', bgMap: ['东城区', '西城区', '朝阳区', '丰台区', '石景山区', '海淀区', '门头沟区', '房山区', '通州区', '顺义区', '昌平区', '大兴区', '平谷区', '怀柔区', '密云县', '延庆县'], areaColor: false, user: '', phone: '', address: '' };}, onShow: function onShow() {var token = wx.getStorageSync('token');
    if (!token) {
      uni.showToast({
        title: '请先登录再进行预约',
        icon: 'none',
  ...
  methods: {
    ...
    yearChange: function yearChange(e) {
      ...
      var beforeYear = this.years[e.target.value];
